                        ...
                        <Form>
                            <Form.Row>
                                <Form.Group as={Col}>
                                    ...
                                    <Form.Control type="text" placeholder="Фамилия" onChange={this.changeSurname} />
                                </Form.Group>
                                <Form.Group as={Col}>
                                    <Form.Label>Имя</Form.Label>
                                    <Form.Control type="text" placeholder="Имя" onChange={this.changeName} />
                                </Form.Group>
                                <Form.Group as={Col}>
                                    <Form.Label>Отчество</Form.Label>
                                    <Form.Control type="text" placeholder="Отчество" onChange={this.changePatronymic} />
                                </Form.Group>
                            </Form.Row>
                            <Form.Row>
                                <Form.Group as={Col}>
                                ...
                                <Form.Group as={Col}>
                                    ...
                                    <Form.Control type="email" placeholder="email@gmail.com" onChange={this.changeEmail} />
                                </Form.Group>
                                <Form.Group as={Col}>
                                    <Form.Label>Дата рождения</Form.Label>
                                    <Form.Control type="date" placeholder="Введите дату рождения" onChange={this.changeBorn} />
                                </Form.Group>
                                <Form.Group as={Col}>
                            ...
                            {!validate ?
                                <div className="edit-buttons">
                                    <Button variant={'success'} onClick={this.addNewPerson}>Добавить</Button>
                                </div> :
                                <div className="edit-buttons">
                                    <Button variant={'primary'} onClick={this.addNewPerson} disabled>Добавить</Button>
                                </div>
                            }
                        </Form>
                    </div>
